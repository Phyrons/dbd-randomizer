...
function construirPista(listaBase) {
 ...
 // Ahora es 100% dinámico: usa el archivo de imagen definido en el JSON
 div.innerHTML = `<img src="img/${perk.archivo}" alt="${state.idiomaActual === "esp" ? perk.nombre_es : perk.nombre}">`;
...
function mostrarGanador(perk, forcedIndex = null) {
 ...
 // Renderizado unificado y limpio para cualquier perk (incluyendo Sin Perk)
